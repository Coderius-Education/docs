...
play.new_box(width=200, height=200)`} height={300} />

### Opdracht 1.3.a: Een weg tekenen

We gaan deze afbeelding namaken met **play.new_box**
![weg](weg.png)

Maar hoe doen we dat eigenlijk? We helpen je een beetje op gang.
Vanaf nu is het weer heel handig om te kijken in de [Cheatsheet](/docs/cheatsheet).
