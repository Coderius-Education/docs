...
# 10.9 Pymunk: een vloer toevoegen
...
In de vorige les viel de bal naar beneden en verdween van het scherm. Met een vloer eronder kan hij stuiteren.
...
Een `Segment` is een lijn van punt `(0, 550)` naar punt `(800, 550)` met dikte `5`. Precies wat je nodig hebt voor een vloer.
...
## Opdracht 10.9.a: Elasticity uitproberen
...
## Opdracht 10.9.b: Muren toevoegen
