...
## Opdracht 10.3.a: Meerdere vormen
...
Alle drie de vormen teken je binnen de game-loop, ná `scherm.fill(...)` en vóór `pygame.display.flip()`. Anders overschrijft de achtergrond ze weer.
...
## Opdracht 10.3.b: Een gezicht tekenen
...
Een gezicht is gewoon drie cirkels en een lijn over elkaar heen. De volgorde bepaalt wat je ziet: het hoofd eerst, de ogen daarna.
