...
/>
Soms wil je een pauze in je spel. Bijvoorbeeld om een object even te laten wachten voordat het weer verdergaat. Een veelgebruikte functie in Python is `time.sleep()`. In een `play`-programma pakt die alleen anders uit dan je verwacht.
