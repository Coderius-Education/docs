...
Het stappenplan hierboven loopt de opzet al door. De kern is dat de animatie-functie blijft draaien en met een `if` kijkt welke animatie op dit moment aan de beurt is.
