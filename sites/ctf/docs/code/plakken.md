...
Is de code Python? Dan kun je 'm hieronder plakken en direct uitvoeren — zonder iets te installeren.

<InlineEditor
  runner="python"
  title="Python-editor"
  code={'# Plak hier de code van de challenge\n'}
  persistKey="ctf-plakken"
/>
