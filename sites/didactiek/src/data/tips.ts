...
export const tips: Tip[] = [
  {
    ...
    termen: ['cognitive load', 'werkgeheugen', 'intrinsieke belasting', 'split attention'],
    samenvatting: 'Eén concept per pagina; het werkgeheugen verwerkt maar een paar nieuwe dingen tegelijk.',
