...
- **Bibliotheek versus lego_auto** — twee rollen, twee stijlen:
  - De **Bibliotheek** (`docs/`) is naslag: complete, vlot uit te voeren scripts die je kunt kopiëren. Daar blijft de huidige stijl gelden.
...
- Opdrachten volgen `## Opdracht <H>.<S>.<letter>:` met H = categoriepositie en S = sidebar_position (bewaakt door `src/lego-tests/structuur.test.ts`). Alleen het slotstuk (10.4.a) heeft geen uitgewerkte oplossing, en dat wordt in Deel 7 aangekondigd.
