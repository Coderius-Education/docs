...
De laatste drie onderwerpen maken samen het gastenboek af dat je leerlingen in de database-lessen bouwen. Tot en met "POST naar database" kunnen ze wel opslaan maar niet tonen; daarna hebben ze een werkende webapplicatie met een overzicht, een detailpagina en nette foutafhandeling.
