...
| Data ophalen met fetch | JavaScript praat met je eigen endpoints, zonder paginawissel |
...
De twee laatste onderwerpen brengen JavaScript in beeld. Je leerlingen kennen het al uit de web-cursus; nieuw is de vraag wáár code hoort. Die vraag komt bewust pas aan het eind, als ze het verschil hebben gevoeld: een formulier versturen gaat via de server en de pagina verspringt, een tekenteller draait in de browser en de server ziet er niets van. Daarna haalt `fetch` data op bij je eigen endpoints, en sluit "Server of browser?" de driehoek: server, browser, of allebei.
