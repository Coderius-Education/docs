...
Drie keer onderweg staat een diagram van de hele keten, browser links en server rechts, met per stap een link naar de les. Ze staan [bij één klik](/docs/FastAPI/verzoek-get) aan het eind van het gastenboek, [bij één formulier](/docs/FastAPI/verzoek-post) direct daarna, en [bij een sessie](/docs/FastAPI/verzoek-sessie) aan het eind van Onthouden. [Hoe een verzoek werkt](/docs/FastAPI/hoe-een-verzoek-werkt) bundelt ze bij het afronden met een tabel "waar hoort jouw code", handig bij het eigen project.
