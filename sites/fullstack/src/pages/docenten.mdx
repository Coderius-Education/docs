...
Vanaf "JavaScript erbij" komt de browserkant in beeld. Je leerlingen kennen JavaScript al uit de web-cursus; nieuw is de vraag wáár code hoort. Die vraag krijgt een eigen les ("Server of browser?") nadat ze het verschil hebben gevoeld: een formulier versturen gaat via de server en de pagina verspringt, een tekenteller draait in de browser en de server ziet er niets van. `fetch` zit daartussen: JavaScript dat zelf data ophaalt bij je eigen endpoints. De cursus sluit af met de server openzetten voor het netwerk en de eindopdracht.
