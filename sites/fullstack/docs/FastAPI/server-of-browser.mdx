...
Je gastenboekveld heeft `maxlength="80"`. Klik met de rechtermuisknop op het invoerveld en kies **Inspecteren**: de ontwikkelaarstools openen op het tabblad **Elementen** (**Elements**), met precies dat `<input>` geselecteerd. Dubbelklik op `maxlength="80"` en haal het weg. Typ nu een heel lang bericht en verstuur het.
