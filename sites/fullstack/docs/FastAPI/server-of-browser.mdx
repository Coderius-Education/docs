...
<details>
<summary>Achtergrond: en als de browser tóch iets van de server nodig heeft?</summary>

Dan kan JavaScript zelf een verzoek doen aan een van jouw endpoints, zonder dat de pagina verspringt. Zo werken de meeste sites die je kent: je klikt op "meer laden" en er komen berichten bij zonder dat je iets ziet knipperen.

Daarvoor bestaat `fetch`. Dat valt buiten deze cursus, maar het is een logische volgende stap als je hier verder in wilt.
...
Zit jouw browser-idee eigenlijk aan data die nog niet op de pagina staat? Dan hoort het toch bij de server — of je hebt `fetch` nodig, zie het blok bovenaan deze pagina.
