...
De middelste kolom is wat je in [Zonder herladen met htmx](/docs/FastAPI/htmx) deed. Het is nog steeds de server: dezelfde endpoints, dezelfde database, dezelfde controles. Alleen de pagina blijft staan. Voor de hoofdvraag maakt dat niets uit.
