...
De namen staan hier in het Nederlands met het Engels erachter, want Chrome en Edge wisselen daarin. Deze les gaat over Netwerk. Console en Elementen krijgen een eigen les, [Console en Elementen](/docs/FastAPI/devtools-console), en App komt bij [cookies](/docs/FastAPI/cookies).
