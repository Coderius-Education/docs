...
- **Niets ergs** — dan mag het in de cookie. Hij verandert zijn eigen naam in het formulier, of zet het donkere thema aan terwijl hij het lichte koos. Hij benadeelt niemand, ook zichzelf niet.
- **Dan komt hij ergens waar hij niet hoort** — dan moet het een sessie zijn. Berichten van iemand anders verwijderen, betalen zonder te betalen, bij andermans gegevens komen.
...
Bij site B verandert er niets: je hebt een sessie-id gewijzigd dat nu nergens meer op past, dus de server behandelt je als een nieuwe bezoeker met een leeg formulier. Je komt niet in de sessie van die ander terecht — daarvoor zou je zijn sessie-id moeten raden, en dat zijn 32 willekeurige tekens.
...
Verandert een bezoeker deze cookie in `banaan`, dan valt hij terug op de standaardvolgorde. Vervelend voor hem, verder gebeurt er niets — en dat is precies waarom een cookie hier genoeg is.
