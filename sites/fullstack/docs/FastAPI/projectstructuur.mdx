...
htmx is één bestand in een nieuwe map `static/js/`. Bij de recepten in [Wat kan htmx allemaal](/docs/FastAPI/htmx-overzicht) komt `berichten_lijst.html` erbij: een stuk pagina zonder `<html>` eromheen, dat een endpoint als antwoord teruggeeft.
