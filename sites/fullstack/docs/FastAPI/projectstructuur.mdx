...
htmx is één bestand in een nieuwe map `static/js/`. In [Ophalen zonder herladen](/docs/FastAPI/htmx-ophalen) komt `berichten_lijst.html` erbij: een stuk pagina zonder `<html>` eromheen, dat een endpoint als antwoord teruggeeft.
