...
<Voorkennis
  items={[
    {site: 'web', to: '/docs/html-css/intro-html', label: 'Intro tot HTML'},
    {site: 'web', to: '/docs/html-css/tekst-opmaken-css', label: 'Tekst opmaken met CSS'},
  ]}
/>
...
<CodeExercise>
{`# Multi-line strings — zo bouw je HTML in Python
naam = "Jan"
kleur = "blue"
...
print(html)
print()
print(f"De HTML is {len(html)} tekens lang.")`}
</CodeExercise>
