...
<Regel n={6}>
Elk bericht krijgt een eigen sleutel met de tijd erin, zodat een nieuw bericht het vorige niet overschrijft. De waarde is een dictionary met beide velden.
</Regel>
