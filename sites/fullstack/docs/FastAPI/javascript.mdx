...
Doet de teller niets? Druk op **F12** en kies het tabblad **Console**: daar staat elke fout uit je JavaScript in het rood. Staat er `Cannot read properties of null`, dan vindt je script het element niet. De Console leer je in de volgende les, [Console en Elementen](/docs/FastAPI/devtools-console), goed kennen. Bekijk de [troubleshooting pagina](/docs/troubleshooting) voor meer oplossingen.
:::
