...
<Voorkennis
  items={[
    ...
    {site: 'web', to: '/docs/js-basics/inline-stijl', label: 'Stijl aanpassen met JavaScript'},
  ]}
/>
...
Doet de teller niets? Druk op **F12** en kies het tabblad **Console**. Daar staat elke fout uit je JavaScript in het rood, met rechts de bestandsnaam en het regelnummer; klik daarop en je springt naar de regel. Staat er `Cannot read properties of null`, dan vindt je script het element niet. Bekijk de [troubleshooting pagina](/docs/troubleshooting) voor meer oplossingen.
:::
