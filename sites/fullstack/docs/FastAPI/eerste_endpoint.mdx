...
Je browser bewaart soms een kopie van een pagina, de **cache**. Pas je iets aan en verandert er niets, dan kijk je naar die kopie. Druk op **Ctrl+Shift+R** om te herladen zonder cache. Hoe je ziet dat het de cache was, en hoe je hem uitzet, staat twee lessen verder bij [Kijken wat de browser doet](/docs/FastAPI/devtools-netwerk).
:::
