...
<Regel n={6}>
De functie heet `root`, maar de naam doet er niet toe; de URL in de regel erboven bepaalt wanneer hij draait. Het `async` hoort bij FastAPI en mag je gewoon overnemen.
</Regel>
