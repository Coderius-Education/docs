...
<CodeExercise>
{`# Een lijst met dictionaries doorlopen, zoals Jinja2 dat in je template doet
berichten = [
...
# Elk bericht op een eigen regel
for bericht in berichten:
    print(f"{bericht['naam']}: {bericht['bericht']}")

print()

# Met een volgnummer, zoals loop.index
for nummer, bericht in enumerate(berichten, start=1):
    print(f"{nummer}. {bericht['naam']}")
...
lege_lijst = []
if lege_lijst:
    print("Er zijn berichten")
else:
    print("Nog geen berichten. Wees de eerste.")`}
</CodeExercise>
