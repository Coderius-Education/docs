...
<CodeExercise>
{`# Database simuleren met een dictionary
import time

database = {}

# Berichten opslaan met unieke keys
berichten = [
    {"naam": "Jan", "bericht": "Hallo!"},
    {"naam": "Sarah", "bericht": "Leuke site!"},
    {"naam": "Piet", "bericht": "Cool project!"}
]

for i, b in enumerate(berichten):
    key = f"bericht_{i}"
    database[key] = b
    print(f"Opgeslagen: {key} → {b}")

# Alle berichten ophalen
print("\\n--- Gastenboek ---")
for key, data in database.items():
    print(f"{data['naam']}: {data['bericht']}")

# Eén bericht ophalen
print(f"\\nLaatste: {database.get('bericht_2', 'Niet gevonden')}")
print(f"Bestaat niet: {database.get('bericht_99', 'Niet gevonden')}")`}
</CodeExercise>
