...
De lessen lopen van installatie naar een complete game. Begin bij [Installatie](/docs/installatie); de [Nodes cheatsheet](/cheatsheet) en [GDScript-tips](/gdscript-tips) zijn naslag.
...
Suggesties, fouten of nieuwe ideeën? Open een issue of pull request op [GitHub](https://github.com/Coderius-Education/Godot). Alle bijdragen — van een typo tot een nieuwe les — zijn welkom.
