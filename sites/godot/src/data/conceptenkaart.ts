...
export const godotConcepten: GodotConcept[] = [
  ...
  // GDScript
  {
    ...
    label: 'var en const',
    leerlijn: 'gdscript',
    to: '/docs/basis_movement_begrijpen#var-const',
  },
  {
    id: 'func-ready',
  ...
  },
  {
    ...
    leerlijn: 'gdscript',
    to: '/docs/movement-motor#physics-process',
  },
  {
    id: 'velocity-move-and-slide',
    label: 'velocity en move_and_slide()',
    leerlijn: 'gdscript',
    to: '/docs/movement-afsluiter#move-and-slide',
  },
  {
    id: 'input-functies',
    label: 'Input-functies',
    leerlijn: 'gdscript',
    to: '/docs/movement-krachten#springen',
  },
  {
    id: 'if-elif',
...
export const conceptenPerLes: Record<string, string[]> = {
  ...
  basis_movement_begrijpen: ['var-const', 'characterbody2d'],
  'movement-motor': ['physics-process-delta'],
  'movement-krachten': [
  ...
  'movement-afsluiter': ['velocity-move-and-slide'],
