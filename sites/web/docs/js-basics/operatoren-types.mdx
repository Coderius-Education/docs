...
<body>
  <p id="regel"></p>
  <p id="totaal"></p>
  <button onclick="maakBon()">Maak de bon</button>
</body>
</html>`;
...
De knop roept `maakBon()` aan. De artikelnaam blijft een string; alleen de prijs en het aantal gaan door `Number()`, want daar reken je mee.
