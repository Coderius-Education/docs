...
:::info[Wat is JavaScript?]
**HTML** bepaalt wat er op de pagina staat. **CSS** bepaalt hoe het eruitziet. **JavaScript** bepaalt wat er *gebeurt*: hoe de pagina reageert op klikken, typen, scrollen of de tijd.

Met JavaScript maak je een statische pagina interactief — knoppen die iets doen, formulieren die reageren, animaties, spelletjes. Een uitgebreide introductie vind je in [Wat is JavaScript](/docs/js-basics/intro-javascript).
:::
...
[← Wat is JavaScript](/docs/js-basics/intro-javascript) | [Inline stijl →](/docs/js-basics/inline-stijl)
