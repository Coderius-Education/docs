...
<body>
  <p id="uitvoer">Klik op de knop.</p>
  <button onclick="checkKorting()">Check korting</button>
</body>
</html>`;
...
- Haal `Number()` weg en vul weer `18` in. Wat toont de pagina nu, en waarom?
- Log `console.log(leeftijd === '18')` erbij en vul `18` in. Verklaar de uitkomst.
...
"Onder 12 óf 65-plus" is één boolean met `||` erin. De knop roept `checkKorting()` aan.
