...
`console.log()` is een opdracht om iets in de **console** te tonen. De console is een verborgen paneel in elke browser waar JavaScript berichten naartoe schrijft — handig om te zien wat je code doet zonder dat de bezoeker het ziet.
...
Je gebruikt `console.log` vooral om te **debuggen** (fouten opsporen): zet het op een paar plekken in je code, en je ziet precies welke regels uitgevoerd worden en met welke waarden. In een gewone browser open je de console met **F12** → tabblad "Console".
