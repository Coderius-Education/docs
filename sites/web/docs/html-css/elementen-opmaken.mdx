...
<CodeOrg slug="elementen-opmaken" />

## Wat ga je leren?

Ruimte rond een element regel je met **padding** en **margin**. Je groepeert hier ook elementen in een `<div>` en geeft die een achtergrondkleur.
