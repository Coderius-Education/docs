...
export const codeorgUnit1: CodeOrgLes[] = (
  [
    ...
    {slug: 'tekst-opmaken-css', lesson: 6, title: 'Styling Text with CSS', nl: 'Tekst opmaken met CSS'},
    ...
    {slug: 'elementen-opmaken', lesson: 9, title: 'Styling Elements with CSS', nl: 'Elementen opmaken'},
