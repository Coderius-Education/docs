...
![Een groot geel huis met rood dak, met linksonder ervoor een klein huisje met rood dak](./img/stap-5-hondenhok.svg)
...
{/* turtle-plaatje: img/stap-5-hondenhok.svg */}
...
Door naar [stap 6: een hele straat](./stap-6-straat).
