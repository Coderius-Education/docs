---
sidebar_position: 1
sidebar_label: 'Stap 1: forward en left'
...
In dit project teken je een huis. Dat doe je met **turtle**: een schildpad
met een pen, die over het scherm loopt en een lijn trekt waar hij langskomt.
Jij geeft de commando's, één voor één, van boven naar beneden.
...
schildpad weer naar rechts, net als aan het begin. Dat heb je in stap 2
nodig.
...
Door naar [stap 2: een huis in kleur](./stap-2-huis).
