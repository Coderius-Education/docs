...
<SiteLink site="algorithms" to="/docs/max-en-min/bouwen/06-tuple-return">Max-en-min</SiteLink> geeft `(klein, groot)` terug, bij <SiteLink site="algorithms" to="/docs/knapsack/bouwen/04-items">knapsack</SiteLink> is elk item een tuple `(waarde, gewicht)`, en de zetten van <SiteLink site="algorithms" to="/docs/hanoi/09-zelf-bouwen">Hanoi</SiteLink> zijn tuples `(bron, doel)`.
:::
