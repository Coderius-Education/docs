...
<SiteLink site="algorithms" to="/docs/max-en-min/05-bouwen-tuple-return">Max-en-min</SiteLink> geeft `(klein, groot)` terug, bij <SiteLink site="algorithms" to="/docs/knapsack/04-bouwen-items">knapsack</SiteLink> is elk item een tuple `(waarde, gewicht)`, en de zetten van <SiteLink site="algorithms" to="/docs/hanoi/09-zelf-bouwen">Hanoi</SiteLink> zijn tuples `(bron, doel)`.
:::
