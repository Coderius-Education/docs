...
<SiteLink site="algorithms" to="/docs/dijkstra/01-concept">Dijkstra</SiteLink> onthoudt zijn bezochte knopen in een set — "wat heb ik al gehad" is precies waar een set voor is. <SiteLink site="algorithms" to="/docs/pagerank/01-concept">PageRank</SiteLink> en <SiteLink site="algorithms" to="/docs/minimax/01-concept">minimax</SiteLink> doen hetzelfde.
:::
