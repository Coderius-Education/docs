...
<SiteLink site="algorithms" to="/docs/dijkstra/01-concept">Dijkstra</SiteLink> houdt per knoop de kortste afstand tot nu toe bij in een dictionary, en <SiteLink site="algorithms" to="/docs/pagerank/01-concept">PageRank</SiteLink> de score per pagina.
:::
