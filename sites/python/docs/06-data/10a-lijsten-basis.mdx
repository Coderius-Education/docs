...
{/* foutmelding-van: ["rood", "groen", "blauw"][3] */}
...
<SiteLink site="algorithms" to="/docs/lineair-zoeken/01-concept">Zoeken</SiteLink> en <SiteLink site="algorithms" to="/docs/bubble-sort/01-concept">sorteren</SiteLink> zijn hoofdstukken lang met lijsten werken; tien van de dertien algoritmes op de <SiteLink site="algorithms" to="/conceptenkaart">conceptenkaart</SiteLink> bouwen op deze les.
:::
