...
{/* niet-draaien: fragment; leerling komt uit het blok erboven */}
```python
...
{/* foutmelding-van: {"naam": "Sam"}["leeftijd"] */}
...
Bij <SiteLink site="algorithms" to="/docs/dijkstra/bouwen/07-kies-volgende">dijkstra</SiteLink> loopt `kies_volgende` met `.items()` langs alle knopen om de dichtstbijzijnde onbezochte te vinden.
:::
