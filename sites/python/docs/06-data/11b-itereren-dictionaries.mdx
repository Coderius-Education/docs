...
Bij <SiteLink site="algorithms" to="/docs/dijkstra/07-bouwen-kies-volgende">dijkstra</SiteLink> loopt `kies_volgende` met `.items()` langs alle knopen om de dichtstbijzijnde onbezochte te vinden.
:::
