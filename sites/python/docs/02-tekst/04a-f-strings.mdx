...
Elke nette uitvoer in de <SiteLink site="algorithms" to="/">algoritmes-cursus</SiteLink> is een f-string: <SiteLink site="algorithms" to="/docs/minimax/01-concept">minimax</SiteLink> print er zijn borden mee, <SiteLink site="algorithms" to="/docs/dijkstra/01-concept">dijkstra</SiteLink> zijn afstandentabel.
:::
