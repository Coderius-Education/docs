...
Je kunt nu zelf functies schrijven. In de volgende les haal je functies binnen die anderen al voor je schreven, met **`import`**.
...
<SiteLink site="algorithms" to="/docs/max-en-min/bouwen/06-tuple-return">Max-en-min</SiteLink> returnt twee waardes tegelijk, en bij <SiteLink site="algorithms" to="/docs/minimax/01-concept">minimax</SiteLink> geven functies scores aan elkaar door — de hele keten hangt aan return.
:::
