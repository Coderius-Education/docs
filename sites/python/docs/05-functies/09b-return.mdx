...
<SiteLink site="algorithms" to="/docs/max-en-min/06-bouwen-tuple-return">Max-en-min</SiteLink> returnt twee waardes tegelijk, en bij <SiteLink site="algorithms" to="/docs/minimax/01-concept">minimax</SiteLink> geven functies scores aan elkaar door — de hele keten hangt aan return.
:::
