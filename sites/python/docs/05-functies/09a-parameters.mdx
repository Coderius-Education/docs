...
{/* foutmelding-van: def adres(straat, nummer): pass\nadres("Hoofdstraat") */}

Vergeet je een argument? Dan krijg je `TypeError: adres() missing 1 required positional argument: 'nummer'`. Python noemt de functie en de parameter die hij mist, want raden welk nummer je bedoelt kan hij niet.
...
<SiteLink site="algorithms" to="/docs/minimax/01-concept">Minimax</SiteLink> bestaat uit zes kleine functies die elkaar het speelbord doorgeven — parameters zijn daar de lijm tussen de onderdelen.
:::
