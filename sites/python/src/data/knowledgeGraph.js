export const knowledgeGraph = {
  concepts: [
    {
      id: 'basis',
      label: 'Basis Concepten',
      description: 'De fundamentele bouwstenen van Python.',
      maxLevel: 5,
    },
    {
      id: 'variabelen',
      label: 'Variabelen',
      description: 'Informatie opslaan en hergebruiken.',
      maxLevel: 5,
    },
    {
      id: 'logica',
      label: 'Logica & Keuzes',
      description: 'Beslissingen maken in je code.',
      maxLevel: 4,
    },
    {
      id: 'herhaling',
      label: 'Herhaling (Loops)',
      description: 'Taken automatiseren door ze te herhalen.',
      maxLevel: 4,
    },
    {
      id: 'functies',
      label: 'Functies',
      description: 'Code structureren en herbruikbaar maken.',
      maxLevel: 4,
    },
    {
      id: 'data',
  ...
  tutorials: [
    ...
    },
    {
      ...
      impact: [
        ...
        {
          concept: 'variabelen',
          depth: 'Je leert dat tekst (strings) tussen aanhalingstekens moet.',
          level: 1,
        },
      ],
    },
    {
      ...
      impact: [
        {
          concept: 'variabelen',
          depth: 'Je leert variabelen aanmaken en waarden overschrijven.',
          level: 2,
        },
    ...
    },
    {
      ...
      impact: [
        {
          concept: 'basis',
          depth: 'Je leert rekenen en datatypen zoals integers en floats.',
          level: 3,
        },
        {
          concept: 'variabelen',
          depth: 'Je leert variabelen gebruiken in berekeningen.',
          level: 3,
        },
      ],
    },
    ...
    },
    {
      id: 't05',
      title: '05. Ja of nee',
      impact: [{ concept: 'logica', depth: 'Je begrijpt Booleans en vergelijkingen.', level: 2 }],
    },
    {
      id: 't06',
      title: '06. Loops',
