...
Vul als bericht (of naam) in: `<script>alert(1);</script>`. Zodra je dit opslaat, wordt het gastenboek opnieuw getoond en krijg je de alert. Stuur nu een gewoon bericht in: de alert verschijnt *weer*, want jouw payload staat nog in het gastenboek en draait bij elke weergave mee. Dat is het verschil met reflected XSS, waar de payload maar één keer terugkomt.
...
- Bij elk volgend bericht verschijnt de pop-up **opnieuw** — het script staat opgeslagen in het gastenboek en draait bij elke weergave mee.
