...
:::tip[Controle]
- Elke aanvalspayload levert de melding `Toegang geweigerd: bestand staat niet op de whitelist.` op.
- Alleen de exacte bestandsnamen `file1.php`, `file2.php` en `file3.php` werken.
