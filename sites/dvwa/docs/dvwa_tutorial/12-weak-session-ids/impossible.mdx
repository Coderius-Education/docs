...
Start het lab en bekijk de gegenereerde waarden.

<DvwaLab module="weak_session_ids" level="impossible" />

Klik meerdere keren op de knop en vergelijk de getoonde waarden. Probeer een patroon te ontdekken of een waarde te voorspellen.

## 3. ✓ Wat moest je zien?

:::tip[Controle]
- De getoonde waarden zijn lange, willekeurig lijkende strings zonder enig zichtbaar patroon.
