...
- Een invoer als `127.0.0.1; ls` wordt niet uitgevoerd: de validatie ziet dat het geen geldig IP-adres is en weigert het.
- Invoer die geen geldig IP-formaat heeft (4 getallen gescheiden door punten) levert een rode foutmelding op: `Ongeldig IP-adres`.
