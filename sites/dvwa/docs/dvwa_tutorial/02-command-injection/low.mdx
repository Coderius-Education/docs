...
De webserver plakt jouw invoer achter het woord `ping`. Begin dus met een geldig IP-adres, en hang daar het scheidingsteken uit §3 en een tweede commando (zoals `ls`) achteraan.
...
![Bestandslijst van de server na een geslaagde command injection](success.png)
