...
> **Labbeperking:** De `#`-hash-truc vereist directe toegang tot de **URL-balk** van je browser, wat niet mogelijk is in het embedded lab. Het lab toont de server-side logica (de whitelist), maar om de aanval daadwerkelijk uit te voeren heb je een [lokale DVWA-installatie](/docs/dvwa_installatie) nodig.
