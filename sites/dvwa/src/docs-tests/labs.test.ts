...
const GEVALLEN: Geval[] = [
  ...
  },
  {
    module: 'sql_injection',
    level: 'high',
    naam: "'-- ' commentaar schakelt LIMIT 1 uit en lekt iedereen",
    invoer: { id: "1' OR '1'='1' -- " },
    verwacht: { bevat: ['admin', 'Gordon', 'Pablo'] },
  },
  {
  ...
  },
  {
    module: 'sql_injection_blind',
    level: 'low',
    naam: "waar-conditie 1' AND '1'='1 meldt bestaat",
    invoer: { id: "1' AND '1'='1" },
    verwacht: { bevat: ['bestaat'], bevatNiet: ['bestaat niet'] },
  },
  {
  ...
  // --- Authorization Bypass (GET) — IDOR: server haalt elk gevraagd profiel op ---
  {
    module: 'authorization_bypass',
    level: 'low',
    naam: 'eigen profiel (id 2) toont geen andermans geheim',
    invoer: { id: '2' },
    verwacht: { bevat: ['Gordon'], bevatNiet: ['supersecret123'] },
  },
  {
    module: 'authorization_bypass',
    level: 'low',
  ...
  },
  {
    module: 'authorization_bypass',
    level: 'low',
    naam: 'admin-ID (1) lekt de geheimen',
    invoer: { id: '1' },
  ...
  },
  {
    module: 'authorization_bypass',
    level: 'medium',
    naam: 'server negeert de dropdown-restrictie',
    invoer: { id: '1' },
    verwacht: { bevat: ['supersecret123'] },
  },
  {
    module: 'authorization_bypass',
    level: 'high',
    naam: 'server heeft geen autorisatie ondanks de JS-controle',
    invoer: { id: '1' },
    verwacht: { bevat: ['supersecret123'] },
  },
  {
    module: 'authorization_bypass',
    level: 'impossible',
    naam: 'ander ID wordt server-side geweigerd',
    invoer: { id: '1' },
    verwacht: { bevat: ['Toegang geweigerd'], bevatNiet: ['supersecret123'] },
  },
  {
    module: 'authorization_bypass',
    level: 'impossible',
    naam: 'eigen profiel blijft toegankelijk',
    invoer: { id: '2' },
    verwacht: { bevat: ['Gordon'], bevatNiet: ['supersecret123'] },
  },
