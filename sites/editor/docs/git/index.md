...
Hier leer je werken met **git** (versiebeheer) en **GitHub** (je code online). Begin bovenaan en werk door naar beneden — elke tutorial bouwt voort op de vorige.
...
7. **[Pull Requests](./pull-request/)** — merge je feature-branch via GitHub, met de mogelijkheid om je wijziging eerst online te bekijken.

## Heb je al ervaring met git?

Je kunt elke tutorial apart bezoeken. Maar als git nieuw voor je is, raden we sterk aan om bij **[Git basis](./basis/)** te beginnen — daar leer je de concepten in een omgeving waar je niets kapot kunt maken.
