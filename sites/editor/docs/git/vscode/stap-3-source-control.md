...
Aan de linkerkant van VS Code zie je een rij iconen. Het derde icoon van boven (een vertakkende lijn) heet **Source Control**. Je kunt het ook openen met **Ctrl+Shift+G** (Windows/Linux) of **Cmd+Shift+G** (macOS).
