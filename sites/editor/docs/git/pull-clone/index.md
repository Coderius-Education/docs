...
1. **Je werkt vanaf meerdere computers.** Thuis push je een commit, op school wil je verder werken — daar moet je eerst pullen om de thuis-commit binnen te halen.
2. **Je werkt samen met een klasgenoot.** Hij pusht een wijziging; jij wil zijn werk hebben voordat je verder bouwt.
...
Begin met **[Stap 1: pull via Sync Changes](./stap-1-sync)**.
