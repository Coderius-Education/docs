...
functie stopt daar met `return`. Het patroon: de grootste schijf gaat
steeds precies in het midden, bij zet `2ⁿ⁻¹` van de `2ⁿ − 1`. Dat is het
recept: eerst `2ⁿ⁻¹ − 1` zetten voor de toren erboven, dan de grootste.
