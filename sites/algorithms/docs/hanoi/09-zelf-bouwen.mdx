...
**Leerdoel:** je gebruikt de zettenlijst om de toestand van de drie palen
bij te houden, en controleert dat de toren echt op doel belandt.
...
Elke paal is een lijst van schijfgroottes, met de grootste onderaan (index
0) en de bovenste schijf achteraan:
