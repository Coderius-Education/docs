...
{/* foutmelding-los: samenvatting van stap 17, waar de melding gereproduceerd wordt */}
...
- [stap 14: helpers](./bouwen/14-helpers) — `max_value` en `min_value`
  als recursie-helpers.
- [stap 15: draai het zelf](./bouwen/15-zelf-draaien) — verzamel je 8
  functies in één lokaal `tictactoe.py` (of in een verzamel-PyRunner
  als noodoplossing).
- [stap 16: minimax](./bouwen/16-minimax) — de AI zelf, geschreven in
