...
:::info
Deze berekening bestaat ook als printbare werkvorm in tweetallen, op een andere positie: [14.4 De perfecte speler — minimax op papier](/docs/unplugged/04-minimax-op-papier).
:::
