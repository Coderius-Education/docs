...
Een functie die zichzelf aanroept. Een klein voorbeeld dat niets met
tic-tac-toe te maken heeft:
...
`max_value` (zie ook [er gaat iets mis](../17-fouten)), en de startwaarde
