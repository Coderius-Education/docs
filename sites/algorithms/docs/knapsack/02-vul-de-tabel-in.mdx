...
**Leerdoel:** je vult zelf de OPT-tabel in voor het voorbeeld van de
les (5 items, W=11), leest eruit af welke items in de optimale rugzak
...
Dit zijn de vijf items van het idee, met een rugzak van 11 kg:
...
:::info
Een kleinere tabel klassikaal invullen, met knipkaartjes en een gok-vooraf? Print [Pak de rugzak in](/docs/unplugged/05-pak-de-rugzak-in).
:::
