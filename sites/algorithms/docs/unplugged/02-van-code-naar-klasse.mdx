...
- [Big O — het idee](/docs/big-o/01-concept)
- [Van code naar klasse](/docs/big-o/09-welke-klasse) — dezelfde
  oefening met uitleg per snippet
- [Overzicht per algoritme](/docs/big-o/08-overzicht) — de beslisboom
  met toelichting
