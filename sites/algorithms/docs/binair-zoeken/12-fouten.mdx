...
Geen foutmelding — Python loopt gewoon **oneindig** door. De browser-tab bevriest,
en de Reset-knop reageert dan ook niet meer, want Python draait in
dezelfde tab als de les. Sluit de tab en open de les opnieuw. Je code ben je
dan kwijt, dus kopieer hem eerst naar een kladblok als je iets uitprobeert
wat mis kan gaan.
...
{/* niet-compileren: fragment; alleen de elif-tak van de vergelijking */}
```python
# FOUT
...
Meer uitleg: [Bouwsteen 3 — vergelijken](./bouwen/06-vergelijken).
