...
- [wat is een graph?](./01-concept) — opnieuw door het concept.
- [met pen en papier](./02-met-pen-en-papier) — hand-trace
  voor wie het algoritme nog niet "ziet".
- [het complete algoritme](./10-compleet) — alles samen met
  visualisatie.
