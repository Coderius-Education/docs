...
Tijdens het doorlopen wil je weten of het huidige element gelijk is aan
het doel. Zo ja, dan meld je iets; zo nee, dan loop je door.
...
- Met `doel = 1` staat er twee keer `gevonden`, want de 1 komt twee keer voor.
