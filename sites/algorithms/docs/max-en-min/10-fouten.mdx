...
Geen foutmelding, maar wel het hele punt van dit algoritme gemist.
...
**Oplossing:** één for-lus met twee accumulators, en per element hoogstens
twee vergelijkingen.
...
# GOED
def max_en_min_goed(lijst):
    klein = groot = lijst[0]
    ...
```

Meer uitleg: [Bouwsteen 1 — twee variabelen](./bouwen/04-twee-variabelen).
