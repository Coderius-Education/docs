...
export const pythonConcepten: PythonConcept[] = [
  ...
  { id: 'functies', label: 'Functies', to: '/docs/functies/functies' },
...
export const voorkennisPerAlgoritme: Record<string, string[]> = {
  ...
  'selection-sort': ['if-else', 'for-loop', 'functies', 'return', 'lijsten', 'tuples'],
  'bubble-sort': ['f-strings', 'if-else', 'for-loop', 'functies', 'return', 'lijsten', 'tuples'],
  'big-o': [
    'if-else',
    'and-or-elif',
    'for-loop',
